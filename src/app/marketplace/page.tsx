...
const mockProducts = [
  ...
  { id: '3', name: 'product_silk_scarf', price: '950', artisan: 'artisan_lambani_tribe', image: PlaceHolderImages.find(img => img.id === 'product-3') },
  { id: '4', name: 'product_remnant_wallet', price: '700', artisan: 'artisan_siddi_tribe', image: PlaceHolderImages.find(img => img.id === 'product-4') },
